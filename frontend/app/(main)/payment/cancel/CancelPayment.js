...
const CancelPayment = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-linear-to-br from-[#191949] via-[#0c0c3a] to-[#3b0a43] text-white relative overflow-hidden">
      {/* Soft gradient overlays on top and bottom */}
      {/* <div className="absolute top-0 left-0 w-full h-40 bg-linear-to-b from-[#292F6E] via-transparent to-transparent pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-full h-40 bg-linear-to-t from-[#B400CF] via-transparent to-transparent pointer-events-none" /> */}
      ...
      <div className="max-w-xl w-full text-center bg-white/10 backdrop-blur-md p-8 sm:p-10 rounded-3xl shadow-xl border border-white/10 z-10">
        <h1 className="text-4xl sm:text-5xl font-extrabold mb-4 bg-linear-to-r from-yellow-400 to-yellow-600 text-transparent bg-clip-text">
          ⚠️ Payment Canceled
        </h1>
