...
import { fetchAllAccessSubscribers } from "@/redux/slices/usersSlice";
import UserTableBase from "../../UserTableBase";

const AllAccessSubscriberTable = () => {
  ...
  useEffect(() => {
    dispatch(fetchAllAccessSubscribers(page));
  }, [dispatch, page]);
...
export default AllAccessSubscriberTable;
